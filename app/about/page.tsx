        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex justify-center">
            <div className="relative">
              <div className="w-32 h-32 bg-linear-to-br from-[#2090C4]/20 to-[#2090C4]/5 rounded-full flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="bg-white rounded-2xl shadow-xl p-8 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-[#2090C4]/10 to-transparent rounded-full transform translate-x-16 -translate-y-16 z-0"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group relative bg-white rounded-2xl shadow-lg p-8 transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
              ...
              <div className="w-16 h-16 bg-linear-to-br from-[#2090C4]/20 to-[#2090C4]/5 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="text-center p-8 bg-linear-to-br from-[#2090C4]/5 to-transparent rounded-2xl shadow-lg border border-[#2090C4]/10">
            ...
            <div className="text-center p-8 bg-linear-to-br from-green-500/5 to-transparent rounded-2xl shadow-lg border border-green-500/10">
            ...
            <div className="text-center p-8 bg-linear-to-br from-blue-500/5 to-transparent rounded-2xl shadow-lg border border-blue-500/10">
