        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/hardware" className="text-gray-400 hover:text-white transition-colors">Hardware</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>info@smatechgroup.com</li>
              <li>+263 86 8800 8361</li>
              <li>13 Brentwood Avenue<br />Groombridge, Harare<br />Zimbabwe</li>
            </ul>
          </div>
        </div>
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} SmatAccess. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
